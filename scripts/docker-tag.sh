...
docker tag ros_builder:latest-cuda ghcr.io/greenroom-robotics/ros_builder:$1-cuda
echo "ghcr.io/greenroom-robotics/ros_builder:cuda-latest"
docker tag ros_builder:latest-cuda ghcr.io/greenroom-robotics/ros_builder:latest-cuda